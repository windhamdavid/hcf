	...
	<div class="container">
		...
		<div class="row text-center">
			<div class="col-md-4">
				...
				<h4 class="service-heading">Rocket Ship</h4>
			...
			<div class="col-md-4">
				...
				<h4 class="service-heading">Bicycle</h4>
				<p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
			</div>
			<div class="col-md-4">
				<span class="fa-stack fa-4x">
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="team-member">
					<img src="img/225x225.jpg" class="img-responsive img-circle" alt="">
					<h4>Person Company One</h4>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<ul class="list-inline quicklinks">
					<li><a href="#">Holy City Farms</a></li>
					<li><a href="#">Wadmalaw Island, South Carolina</a></li>
				</ul>
			</div>
		</div>
	</div>
